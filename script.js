document.addEventListener('DOMContentLoaded', () => {
    ...
    const currentCoverElement = document.getElementById('currentCover'); // Récupération de l'élément image de la pochette
    ...
    function playNow(song) {
        ...
        audioPlayer.play()
            .then(() => {
                ...
                currentCoverElement.src = song.artist_image || defaultCoverUrl; // Mise à jour de la pochette
            })
            .catch(error => {
                console.error("Erreur lors de la lecture du fichier MP3:", error);
                audioPlayer.src = '';
                currentSongTitleElement.textContent = '';
                currentCoverElement.src = defaultCoverUrl; // Assurez-vous d'avoir une image par défaut
            });
    }
